(function() {
  var LgSearchQueryParser, Parser;
  ...
  LgSearchQueryParser = (function() {
    var operator, token, _ref;
    __extends(LgSearchQueryParser, Parser);
    function LgSearchQueryParser() {
      LgSearchQueryParser.__super__.constructor.apply(this, arguments);
    }
    LgSearchQueryParser.TOKEN_TO_OPERATOR = {
      less_than: '<',
      less_than_or_equals: '<=',
      greater_than: '>',
    ...
    LgSearchQueryParser.OPERATOR_TO_TOKEN = {};
    _ref = LgSearchQueryParser.TOKEN_TO_OPERATOR;
    for (token in _ref) {
      operator = _ref[token];
      LgSearchQueryParser.OPERATOR_TO_TOKEN[operator] = token;
    }
    LgSearchQueryParser.NOT_TOKEN = {
    ...
    LgSearchQueryParser.tokenize = function(input) {
    ...
    LgSearchQueryParser.parse = function(input) {
    ...
    LgSearchQueryParser.sanitize = function(query) {
    ...
    LgSearchQueryParser.attributesToFilters = function(attributes) {
